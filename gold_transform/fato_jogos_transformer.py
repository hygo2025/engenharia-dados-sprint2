...
class FatoJogosTransformer(BaseTransformer):
    ...
    def transform_data(self):
        ...
        df = df_home_away.merge(df_clube, left_on='clube_mandante', right_on='nome', how='left').rename(columns={'clube_id': 'clube_mandante_id'})
        df = df.merge(df_clube, left_on='clube_visitante', right_on='nome', how='left').rename(columns={'clube_id': 'clube_visitante_id'})
